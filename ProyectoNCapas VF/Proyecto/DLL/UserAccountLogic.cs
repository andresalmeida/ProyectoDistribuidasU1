...
namespace BLL
{
    public class UserAccountLogic
    {
        ...
        // Método para actualizar la cuenta de usuario
        ...
        // Método para actualizar solo la contraseña (PasswordHash)
        public bool UpdatePassword(int userId, string newPassword)
        {
            ...
            using (var repository = RepositoryFactory.CreateRepository())
            {
                var userAccountToUpdate = repository.Retrieve<UserAccount>(u => u.UserID == userId);
                ...
                // Hashear la nueva contraseña y asignarla al campo PasswordHash
                userAccountToUpdate.PasswordHash = BCrypt.Net.BCrypt.HashPassword(newPassword);
